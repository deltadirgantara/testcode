class Fix_Cost_Controller < ApplicationController
  before_action :require_login

  def index
  	@fix_costs = Fix_Cost.page param_page
  end

  def show
  	return redirect_back_data_error fix_costs_path, "Date tidak ditemukan" if params[:id].nil?
  	@fix_cost = Fix_Cost.find_by(id: params[:id])
  ...
  def create
    fix_cost = Fix_Cost.new fix_cost_params
