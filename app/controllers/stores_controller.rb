class StoresController < ApplicationController
  ...
  def create
    ...
    return redirect_success store_path(id: store.id), "Toko - " + store.name + " - Berhasil Disimpan"
  end
  ...
  def update
    ...
    return redirect_success store_path(store.id), "Data Toko - " + store.name + " - Berhasil Diubah"
  end
